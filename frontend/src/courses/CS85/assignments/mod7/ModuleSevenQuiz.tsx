...
import { moduleSevenQuizQuestions } from "./quizData";
...
export const moduleSevenQuizDefinition = {
  id: "cs85-module-07-laravel-quiz",
  delivery: "client-practice",
  eyebrow: "CS 85 · Module 7",
  title: "Quiz: Module 7 Laravel",
  summary:
    "Review Laravel installation, routing, controllers, MVC responsibilities, and Blade templates.",
  accessCode: "START",
  accessHint: "Access code: START",
  durationSeconds: 60 * 60,
  storageKey: "assessment:cs85-module-07-laravel-quiz:v1",
  questions: moduleSevenQuizQuestions,
} satisfies AssessmentDefinition;

assertAssessmentDefinition(moduleSevenQuizDefinition);

export default function ModuleSevenQuiz() {
  return (
    <AssessmentRunner
      definition={moduleSevenQuizDefinition}
...
function QuizDetails() {
  return (
    <details
      data-testid="module-seven-quiz-details"
    ...
    >
      ...
      <div className="space-y-3 border-t border-slate-200 px-5 pt-4 pb-5 text-sm leading-7 text-slate-700 dark:border-slate-700 dark:text-slate-200">
        ...
        <p>
          This study mirror uses a 60-minute practice session so progress,
          autosave, review, and attempt restoration remain consistent with the
          shared assessment experience. The source Canvas quiz has no time
          limit.
        </p>
      </div>
    </details>
