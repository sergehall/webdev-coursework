    ...
    <div className="space-y-6">
      <div className="grid gap-4 lg:grid-cols-3">
        <OverviewList
          ...
          className="border-sky-200 bg-sky-50 dark:border-sky-900/50 dark:bg-sky-950/40"
...
function ModuleSummary({ module }: { module: CS79CModuleBlueprint }) {
  return (
...
function ServiceHighlights({ module }: { module: CS79CModuleBlueprint }) {
  return (
...
function OverviewScreenshots({ module }: { module: CS79CModuleBlueprint }) {
  return (
